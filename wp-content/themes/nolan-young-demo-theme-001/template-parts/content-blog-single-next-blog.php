...
<section class="section section--cream related-journal" id="related-reading">
	<div class="content-wrap">
		<nav class="article-adjacent" aria-label="<?php esc_attr_e( 'Previous and next articles', 'nolan-young-demo-theme-001' ); ?>" data-reveal>
			<?php if ( $previous_post ) : ?>
				<a href="<?php echo esc_url( get_permalink( $previous_post ) ); ?>">
					<span><?php esc_html_e( 'Previous perspective', 'nolan-young-demo-theme-001' ); ?></span>
			...
			<?php else : ?>
				<span class="article-adjacent__empty">
					<span><?php esc_html_e( 'Previous perspective', 'nolan-young-demo-theme-001' ); ?></span>
					<strong><?php esc_html_e( 'You are at the beginning of this journal sequence.', 'nolan-young-demo-theme-001' ); ?></strong>
				</span>
			<?php endif; ?>

			<?php if ( $next_post ) : ?>
				<a href="<?php echo esc_url( get_permalink( $next_post ) ); ?>">
					<span><?php esc_html_e( 'Next perspective', 'nolan-young-demo-theme-001' ); ?></span>
			...
			<?php else : ?>
				<a href="<?php echo esc_url( get_permalink( get_option( 'page_for_posts' ) ) ?: home_url( '/journal/' ) ); ?>">
					<span><?php esc_html_e( 'Editorial index', 'nolan-young-demo-theme-001' ); ?></span>
					<strong><?php esc_html_e( 'Return to every published perspective.', 'nolan-young-demo-theme-001' ); ?></strong>
					<i aria-hidden="true">→</i>
				</a>
			<?php endif; ?>
		</nav>
		...
		<?php if ( $related->have_posts() ) : ?>
			<header class="related-journal__heading" data-reveal>
				<div>
					<p class="eyebrow"><?php esc_html_e( 'Continue the thread', 'nolan-young-demo-theme-001' ); ?></p>
					<h2><?php esc_html_e( 'Related perspectives selected by topic.', 'nolan-young-demo-theme-001' ); ?></h2>
				</div>
				<a class="text-link" href="<?php echo esc_url( get_permalink( get_option( 'page_for_posts' ) ) ?: home_url( '/journal/' ) ); ?>">
					<?php esc_html_e( 'Open the journal', 'nolan-young-demo-theme-001' ); ?>
				...
				<?php while ( $related->have_posts() ) : ?>
					...
					<article class="related-card" data-reveal>
						<a class="related-card__visual" href="<?php the_permalink(); ?>">
							<?php nydemo001_editorial_visual( get_the_ID(), 'medium_large' ); ?>
						</a>
						<div>
