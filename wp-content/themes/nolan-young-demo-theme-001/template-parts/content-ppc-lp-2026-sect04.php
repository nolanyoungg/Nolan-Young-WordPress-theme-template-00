...
<section class="section section--cream ppc-timeline">
	<div class="content-wrap">
		<header class="section-heading section-heading--split" data-reveal>
			<div>
				<p class="eyebrow"><?php esc_html_e( 'Six-week activation path', 'nolan-young-demo-theme-001' ); ?></p>
				<h2><?php esc_html_e( 'From fragmented signals to a live learning system.', 'nolan-young-demo-theme-001' ); ?></h2>
			</div>
			<p><?php esc_html_e( 'A clear sequence gets the first high-value experience live quickly without confusing speed with skipped thinking.', 'nolan-young-demo-theme-001' ); ?></p>
		</header>
		...
		<div class="ppc-timeline__handoff" data-reveal>
			<span><?php esc_html_e( 'Built to transfer', 'nolan-young-demo-theme-001' ); ?></span>
			<p><?php esc_html_e( 'Your team leaves with the system, working artifacts, decision logic, and a repeatable optimization rhythm.', 'nolan-young-demo-theme-001' ); ?></p>
		</div>
	</div>
</section>
