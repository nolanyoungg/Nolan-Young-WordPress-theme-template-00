...
<section class="section" id="project-library">
	<div class="content-wrap">
		<header class="section-heading section-heading--split" data-reveal>
			<div>
				<p class="eyebrow"><?php esc_html_e( 'Project library', 'nolan-young-demo-theme-001' ); ?></p>
				<h2><?php esc_html_e( 'Different problems. The same standard of clarity.', 'nolan-young-demo-theme-001' ); ?></h2>
			</div>
			<p><?php esc_html_e( 'Filter this fictional portfolio by the capability that led the engagement.', 'nolan-young-demo-theme-001' ); ?></p>
		</header>
		<div class="work-filter" role="group" aria-label="<?php esc_attr_e( 'Filter projects', 'nolan-young-demo-theme-001' ); ?>" data-work-filters>
			<button class="is-active" type="button" data-work-filter="all"><?php esc_html_e( 'All work', 'nolan-young-demo-theme-001' ); ?></button>
			<button type="button" data-work-filter="strategy"><?php esc_html_e( 'Strategy', 'nolan-young-demo-theme-001' ); ?></button>
			<button type="button" data-work-filter="experience"><?php esc_html_e( 'Experience', 'nolan-young-demo-theme-001' ); ?></button>
			<button type="button" data-work-filter="platform"><?php esc_html_e( 'Platform', 'nolan-young-demo-theme-001' ); ?></button>
		</div>
		...
		<p class="work-filter__empty" data-work-empty hidden><?php esc_html_e( 'No projects match this filter.', 'nolan-young-demo-theme-001' ); ?></p>
	</div>
</section>
