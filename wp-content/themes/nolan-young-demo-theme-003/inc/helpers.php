...
function nydemo003_asset_url( $path ) {
 ...
 * @return string
 */
function nydemo003_page_url( $path ) {
...
function nydemo003_section_intro( $eyebrow, $title, $copy = '' ) {
	?>
...
function nydemo003_button( $label = 'Start a project', $url = '' ) {
 ...
 * @return int
 */
function nydemo003_reading_time( $post_id = 0 ) {
 ...
 * @return WP_Term|null
 */
function nydemo003_primary_category( $post_id = 0 ) {
 ...
 * @return int
 */
function nydemo003_featured_post_id() {
 ...
 * @return void
 */
function nydemo003_editorial_visual( $post_id, $size = 'large', $class = '' ) {
