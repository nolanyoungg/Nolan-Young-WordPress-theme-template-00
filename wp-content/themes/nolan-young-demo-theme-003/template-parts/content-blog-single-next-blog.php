...
<section class="section section--cream related-journal" id="related-reading">
	<div class="content-wrap">
		<nav class="article-adjacent" aria-label="<?php esc_attr_e( 'Previous and next articles', 'nolan-young-demo-theme-003' ); ?>" data-reveal>
			<?php if ( $previous_post ) : ?>
				<a href="<?php echo esc_url( get_permalink( $previous_post ) ); ?>">
					<span><?php esc_html_e( 'Previous perspective', 'nolan-young-demo-theme-003' ); ?></span>
			...
			<?php else : ?>
				<span class="article-adjacent__empty">
					<span><?php esc_html_e( 'Previous perspective', 'nolan-young-demo-theme-003' ); ?></span>
					<strong><?php esc_html_e( 'You are at the beginning of this journal sequence.', 'nolan-young-demo-theme-003' ); ?></strong>
				</span>
			<?php endif; ?>

			<?php if ( $next_post ) : ?>
				<a href="<?php echo esc_url( get_permalink( $next_post ) ); ?>">
					<span><?php esc_html_e( 'Next perspective', 'nolan-young-demo-theme-003' ); ?></span>
			...
			<?php else : ?>
				<a href="<?php echo esc_url( get_permalink( get_option( 'page_for_posts' ) ) ?: home_url( '/journal/' ) ); ?>">
					<span><?php esc_html_e( 'Editorial index', 'nolan-young-demo-theme-003' ); ?></span>
					<strong><?php esc_html_e( 'Return to every published perspective.', 'nolan-young-demo-theme-003' ); ?></strong>
					<i aria-hidden="true">→</i>
				</a>
			<?php endif; ?>
		</nav>
		...
		<?php if ( $related->have_posts() ) : ?>
			<header class="related-journal__heading" data-reveal>
				<div>
					<p class="eyebrow"><?php esc_html_e( 'Continue the thread', 'nolan-young-demo-theme-003' ); ?></p>
					<h2><?php esc_html_e( 'Related perspectives selected by topic.', 'nolan-young-demo-theme-003' ); ?></h2>
				</div>
				<a class="text-link" href="<?php echo esc_url( get_permalink( get_option( 'page_for_posts' ) ) ?: home_url( '/journal/' ) ); ?>">
					<?php esc_html_e( 'Open the journal', 'nolan-young-demo-theme-003' ); ?>
