...
<section class="section ppc-system">
	<div class="content-wrap ppc-system__layout">
		<header class="ppc-system__intro" data-reveal>
			<p class="eyebrow"><?php esc_html_e( 'One connected demand system', 'nolan-young-demo-theme-003' ); ?></p>
			<h2><?php esc_html_e( 'Four layers. One commercial signal.', 'nolan-young-demo-theme-003' ); ?></h2>
			<p><?php esc_html_e( 'The campaign, experience, measurement, and operating rhythm are designed together—not passed between isolated teams after the important decisions have already been made.', 'nolan-young-demo-theme-003' ); ?></p>
			<div class="ppc-system__key">
				<span><?php esc_html_e( 'Input', 'nolan-young-demo-theme-003' ); ?></span>
				<i></i>
				<span><?php esc_html_e( 'System', 'nolan-young-demo-theme-003' ); ?></span>
				<i></i>
				<span><?php esc_html_e( 'Learning', 'nolan-young-demo-theme-003' ); ?></span>
			</div>
		</header>
		<ol class="ppc-stack">
