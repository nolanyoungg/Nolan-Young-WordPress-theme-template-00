...
<section class="section recovery-journal">
	<div class="content-wrap">
		<header class="section-heading section-heading--split" data-reveal>
			<div>
				<p class="eyebrow"><?php esc_html_e( 'A better next click', 'nolan-young-demo-theme-003' ); ?></p>
				<h2><?php esc_html_e( 'Continue with a recent idea.', 'nolan-young-demo-theme-003' ); ?></h2>
			</div>
			<a class="text-link" href="<?php echo esc_url( home_url( '/blog/' ) ); ?>">
				<?php esc_html_e( 'View the full journal', 'nolan-young-demo-theme-003' ); ?>
		...
		<?php else : ?>
			<div class="recovery-journal__empty" data-reveal>
				...
				<div>
					<h3><?php esc_html_e( 'The journal is being prepared.', 'nolan-young-demo-theme-003' ); ?></h3>
					<p><?php esc_html_e( 'Published WordPress posts will appear here automatically. Use the verified routes above in the meantime.', 'nolan-young-demo-theme-003' ); ?></p>
				</div>
			</div>
		<?php endif; ?>
	</div>
