...
<section class="section ppc-faq">
	<div class="content-wrap ppc-faq__layout">
		<header class="ppc-faq__intro" data-reveal>
			<p class="eyebrow"><?php esc_html_e( 'Questions before investment', 'nolan-young-demo-theme-003' ); ?></p>
			<h2><?php esc_html_e( 'Resolve the practical objections early.', 'nolan-young-demo-theme-003' ); ?></h2>
			<p><?php esc_html_e( 'The system is designed to work with the people, platforms, and partners you already have wherever that is the smarter move.', 'nolan-young-demo-theme-003' ); ?></p>
			<div class="ppc-faq__signal">
				<span><?php esc_html_e( 'Integration posture', 'nolan-young-demo-theme-003' ); ?></span>
				<strong><?php esc_html_e( 'Additive by default', 'nolan-young-demo-theme-003' ); ?></strong>
				<i></i>
			</div>
		</header>
