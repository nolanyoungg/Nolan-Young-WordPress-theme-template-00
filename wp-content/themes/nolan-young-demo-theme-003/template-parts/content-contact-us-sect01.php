...
<section class="section section--cream contact-routes">
	<div class="content-wrap">
		<header class="section-heading section-heading--split" data-reveal>
			<div>
				<p class="eyebrow"><?php esc_html_e( 'Choose your starting signal', 'nolan-young-demo-theme-003' ); ?></p>
				<h2><?php esc_html_e( 'Three routes. One senior team.', 'nolan-young-demo-theme-003' ); ?></h2>
			</div>
			<p><?php esc_html_e( 'You do not need a finished scope. Select the situation that feels closest and we will help frame the actual work.', 'nolan-young-demo-theme-003' ); ?></p>
		</header>
			...
			<?php foreach ( $routes as $route ) : ?>
				<article class="contact-route" data-reveal>
					...
					<a class="text-link" href="#project-brief">
						<?php esc_html_e( 'Start with this route', 'nolan-young-demo-theme-003' ); ?>
		...
		<div class="contact-routes__note" data-reveal>
			<span><?php esc_html_e( 'Not sure?', 'nolan-young-demo-theme-003' ); ?></span>
			<p><?php esc_html_e( 'That is useful information too. Describe the tension and we will help identify the right first move.', 'nolan-young-demo-theme-003' ); ?></p>
		</div>
	</div>
</section>
