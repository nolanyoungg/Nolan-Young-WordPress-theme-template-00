...
<section class="section section--cream contact-next">
	<div class="content-wrap">
		<header class="section-heading section-heading--split" data-reveal>
			<div>
				<p class="eyebrow"><?php esc_html_e( 'After you make contact', 'nolan-young-demo-theme-003' ); ?></p>
				<h2><?php esc_html_e( 'From first signal to a confident start.', 'nolan-young-demo-theme-003' ); ?></h2>
			</div>
			<p><?php esc_html_e( 'The process is intentionally lightweight, but every step produces something useful—even if we decide not to work together.', 'nolan-young-demo-theme-003' ); ?></p>
		</header>
		...
		<div class="contact-next__promise" data-reveal>
			<strong><?php esc_html_e( 'Our promise', 'nolan-young-demo-theme-003' ); ?></strong>
			<p><?php esc_html_e( 'If another specialist, sequence, or starting point would serve you better, we will say so clearly.', 'nolan-young-demo-theme-003' ); ?></p>
		</div>
	</div>
</section>
