...
<section class="single-article-hero">
	<div class="content-wrap">
		<nav class="article-breadcrumb" aria-label="<?php esc_attr_e( 'Breadcrumb', 'nolan-young-demo-theme-003' ); ?>" data-reveal>
			<a href="<?php echo esc_url( $journal_url ); ?>"><?php esc_html_e( 'Journal', 'nolan-young-demo-theme-003' ); ?></a>
			<span aria-hidden="true">/</span>
			<?php if ( $category ) : ?>
				<a href="<?php echo esc_url( get_category_link( $category ) ); ?>"><?php echo esc_html( $category->name ); ?></a>
			<?php else : ?>
				<span><?php esc_html_e( 'Perspective', 'nolan-young-demo-theme-003' ); ?></span>
			<?php endif; ?>
		</nav>
		...
		<div class="single-article-hero__layout">
			<div class="single-article-hero__content" data-reveal>
				<div class="single-article-hero__topline">
					<span><?php esc_html_e( 'Journal perspective', 'nolan-young-demo-theme-003' ); ?></span>
					<span><?php echo esc_html( sprintf( '%02d', $reading_time ) ); ?> <?php esc_html_e( 'minute read', 'nolan-young-demo-theme-003' ); ?></span>
				</div>
				<h1><?php the_title(); ?></h1>
					...
					<div>
						...
						<span>
							...
							printf(
								...
								esc_html__( 'Published %s', 'nolan-young-demo-theme-003' ),
			...
			<figure class="single-article-hero__media" data-reveal>
				<?php nydemo003_editorial_visual( get_the_ID(), 'large', 'single-article-hero__visual' ); ?>
				<figcaption>
					<span><?php echo esc_html( $category ? $category->name : __( 'Perspective', 'nolan-young-demo-theme-003' ) ); ?></span>
