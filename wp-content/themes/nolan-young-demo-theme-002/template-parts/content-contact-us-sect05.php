...
<section class="section contact-faq">
	<div class="content-wrap contact-faq__layout">
		<header class="contact-faq__intro" data-reveal>
			<p class="eyebrow"><?php esc_html_e( 'Before we talk', 'nolan-young-demo-theme-002' ); ?></p>
			<h2><?php esc_html_e( 'Clear answers before the first calendar invite.', 'nolan-young-demo-theme-002' ); ?></h2>
			<p><?php esc_html_e( 'The questions enterprise teams usually ask when they are deciding whether a specialist partner is the right move.', 'nolan-young-demo-theme-002' ); ?></p>
