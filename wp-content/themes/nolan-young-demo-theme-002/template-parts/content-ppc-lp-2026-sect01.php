...
<section class="section section--cream ppc-problems">
	<div class="content-wrap">
		<header class="section-heading section-heading--split" data-reveal>
			<div>
				<p class="eyebrow"><?php esc_html_e( 'The expensive space after the click', 'nolan-young-demo-theme-002' ); ?></p>
				<h2><?php esc_html_e( 'Media cannot rescue a disconnected buying journey.', 'nolan-young-demo-theme-002' ); ?></h2>
			</div>
			<p><?php esc_html_e( 'The real waste usually begins after acquisition: unclear value, generic evidence, slow experiences, and measurement that rewards activity instead of opportunity.', 'nolan-young-demo-theme-002' ); ?></p>
		</header>
		<div class="ppc-problem-grid">
			<?php foreach ( $problems as $problem ) : ?>
				<article class="ppc-problem" data-reveal>
					...
					<footer>
						<span><?php esc_html_e( 'Business effect', 'nolan-young-demo-theme-002' ); ?></span>
		...
		<div class="ppc-problems__equation" data-reveal>
			<div><span><?php esc_html_e( 'Paid intent', 'nolan-young-demo-theme-002' ); ?></span><strong><?php esc_html_e( 'Expensive', 'nolan-young-demo-theme-002' ); ?></strong></div>
			<i aria-hidden="true">×</i>
			<div><span><?php esc_html_e( 'Disconnected journey', 'nolan-young-demo-theme-002' ); ?></span><strong><?php esc_html_e( 'Uncertain', 'nolan-young-demo-theme-002' ); ?></strong></div>
			<i aria-hidden="true">=</i>
			<div><span><?php esc_html_e( 'Commercial signal', 'nolan-young-demo-theme-002' ); ?></span><strong><?php esc_html_e( 'Unreliable', 'nolan-young-demo-theme-002' ); ?></strong></div>
		</div>
	</div>
</section>
