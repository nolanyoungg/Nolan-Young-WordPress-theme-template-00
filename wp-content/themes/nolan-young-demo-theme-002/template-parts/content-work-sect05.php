...
<section class="section">
	<div class="content-wrap">
		<header class="section-heading" data-reveal>
			<p class="eyebrow"><?php esc_html_e( 'Capability to outcome', 'nolan-young-demo-theme-002' ); ?></p>
			<h2><?php esc_html_e( 'Every deliverable has a job beyond looking finished.', 'nolan-young-demo-theme-002' ); ?></h2>
		</header>
		<div class="outcome-matrix" data-reveal>
			<div class="outcome-matrix__header"><span><?php esc_html_e( 'Capability', 'nolan-young-demo-theme-002' ); ?></span><span><?php esc_html_e( 'Operational value', 'nolan-young-demo-theme-002' ); ?></span><span><?php esc_html_e( 'Business signal', 'nolan-young-demo-theme-002' ); ?></span><span><?php esc_html_e( 'Evidence artifact', 'nolan-young-demo-theme-002' ); ?></span></div>
