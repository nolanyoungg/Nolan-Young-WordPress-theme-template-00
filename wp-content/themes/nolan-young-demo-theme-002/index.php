...
<main id="content">
	<header class="index-hero">
		<div class="content-wrap index-hero__layout">
			<div data-reveal>
				<p class="eyebrow"><?php esc_html_e( 'Site index / latest content', 'nolan-young-demo-theme-002' ); ?></p>
	...
	<section class="section collection">
		<div class="content-wrap">
			<div class="collection__toolbar" data-reveal>
				<div>
					<span><?php esc_html_e( 'Content stream', 'nolan-young-demo-theme-002' ); ?></span>
					<strong><?php esc_html_e( 'The latest published routes', 'nolan-young-demo-theme-002' ); ?></strong>
				</div>
			</div>
			<?php if ( have_posts() ) : ?>
					...
					<?php while ( have_posts() ) : ?>
						...
						<article <?php post_class( 'collection-card' ); ?> data-reveal>
							...
							<div class="collection-card__body">
								...
								<footer>
									<span><?php esc_html_e( 'Published route', 'nolan-young-demo-theme-002' ); ?></span>
									<a class="text-link" href="<?php the_permalink(); ?>">
										<?php esc_html_e( 'Open content', 'nolan-young-demo-theme-002' ); ?>
				...
				<nav class="pagination-wrap" aria-label="<?php esc_attr_e( 'Content pages', 'nolan-young-demo-theme-002' ); ?>">
			...
			<?php else : ?>
				<div class="collection-empty" data-reveal>
					<span>00</span>
					<div>
						<h2><?php esc_html_e( 'Nothing has been published yet.', 'nolan-young-demo-theme-002' ); ?></h2>
						<p><?php esc_html_e( 'New WordPress content will appear here automatically.', 'nolan-young-demo-theme-002' ); ?></p>
					</div>
				</div>
			<?php endif; ?>
		</div>
