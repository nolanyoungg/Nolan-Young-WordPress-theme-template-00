...
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
<a class="skip-link" href="#content"><?php esc_html_e( 'Skip to content', 'nolan-young-demo-theme-002' ); ?></a>
<header class="site-header" data-site-header>
	<div class="content-wrap site-header__inner">
		...
		<button class="nav-toggle" type="button" aria-expanded="false" aria-controls="site-navigation" data-nav-toggle>
			<span class="screen-reader-text"><?php esc_html_e( 'Toggle menu', 'nolan-young-demo-theme-002' ); ?></span>
			<span></span><span></span>
		</button>
		<?php nydemo002_primary_navigation(); ?>
