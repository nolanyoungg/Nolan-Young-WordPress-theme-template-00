...
function nydemo002_asset_url( $path ) {
 ...
 * @return string
 */
function nydemo002_page_url( $path ) {
...
function nydemo002_section_intro( $eyebrow, $title, $copy = '' ) {
	?>
...
function nydemo002_button( $label = 'Start a project', $url = '' ) {
 ...
 * @return int
 */
function nydemo002_reading_time( $post_id = 0 ) {
 ...
 * @return WP_Term|null
 */
function nydemo002_primary_category( $post_id = 0 ) {
 ...
 * @return int
 */
function nydemo002_featured_post_id() {
 ...
 * @return void
 */
function nydemo002_editorial_visual( $post_id, $size = 'large', $class = '' ) {
