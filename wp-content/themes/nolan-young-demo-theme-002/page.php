			...
			<header class="default-page__hero">
				<div class="content-wrap default-page__hero-layout">
					<div data-reveal>
						...
						<?php else : ?>
							<p class="hero__lede"><?php esc_html_e( 'A focused page from the current site collection.', 'nolan-young-demo-theme-002' ); ?></p>
						<?php endif; ?>
					</div>
					<div class="default-page__meta" data-reveal>
						<header>
							<span><?php esc_html_e( 'Page record', 'nolan-young-demo-theme-002' ); ?></span>
							<small><?php echo esc_html( get_post_status() ); ?></small>
						</header>
						<dl>
							<div>
								<dt><?php esc_html_e( 'Published', 'nolan-young-demo-theme-002' ); ?></dt>
								<dd><?php echo esc_html( get_the_date( 'M j, Y' ) ); ?></dd>
							</div>
							<div>
								<dt><?php esc_html_e( 'Updated', 'nolan-young-demo-theme-002' ); ?></dt>
								<dd><?php echo esc_html( get_the_modified_date( 'M j, Y' ) ); ?></dd>
							</div>
						</dl>
						<footer>
							<span><?php esc_html_e( 'Canonical route', 'nolan-young-demo-theme-002' ); ?></span>
			...
			<section class="section default-page__body">
				<div class="content-wrap default-page__layout">
					<aside class="default-page__aside" data-reveal>
						<span><?php esc_html_e( 'On this page', 'nolan-young-demo-theme-002' ); ?></span>
						<strong><?php the_title(); ?></strong>
						<i></i>
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
							<?php esc_html_e( 'Return to home', 'nolan-young-demo-theme-002' ); ?>
					...
					<div class="entry-content default-page__content" data-reveal>
						...
						wp_link_pages(
							array(
								'before' => '<nav class="page-links" aria-label="' . esc_attr__( 'Page sections', 'nolan-young-demo-theme-002' ) . '">',
								'after'  => '</nav>',
							)
						);
						?>
