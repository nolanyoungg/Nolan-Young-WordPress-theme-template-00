		...
		<div class="nytt01-hero__content">
			...
			<div class="nytt01-button-group">
				<?php if ( $nytt01_contact_url ) : ?>
					<a class="nytt01-button" href="<?php echo esc_url( $nytt01_contact_url ); ?>"><?php esc_html_e( 'Start a project', 'nolan-young-theme-template-01' ); ?></a>
				<?php endif; ?>
				<?php if ( $nytt01_work_url ) : ?>
					<a class="nytt01-button nytt01-button--secondary" href="<?php echo esc_url( $nytt01_work_url ); ?>"><?php esc_html_e( 'View our work', 'nolan-young-theme-template-01' ); ?></a>
				<?php endif; ?>
			</div>
		</div>
