...
class Styles {
	...
	public static function css( $location, $theme_key, $theme, $profile ) {
		...
		$css .= $panel . '{' . $panel_position . ';background:linear-gradient(90deg,' . $mega['background_from'] . ',' . $mega['background_to'] . ');border-color:' . $mega['border_color'] . ';border-style:solid;border-width:' . self::box( $mega, 'border' ) . ';border-radius:' . self::box( $mega, 'radius' ) . ';padding:' . self::box( $mega, 'padding' ) . ';width:' . $panel_width . ';max-width:100vw;}';
		...
		$css .= $title . '{border-color:' . $mega['widget_title_border_color'] . ';border-style:solid;border-width:' . self::box( $mega, 'widget_title_border' ) . ';color:' . $mega['widget_title_color'] . ';font-family:' . $mega['widget_title_family'] . ';font-size:' . $mega['widget_title_size'] . ';font-weight:' . $mega['widget_title_weight'] . ';margin:' . self::box( $mega, 'widget_title_margin' ) . ';padding:' . self::box( $mega, 'widget_title_padding' ) . ';text-align:' . $mega['widget_title_align'] . ';text-decoration:' . $mega['widget_title_decoration'] . ';text-transform:' . $mega['widget_title_transform'] . ';}' . $panel . ' .nymegamenu__widget{color:' . $mega['content_color'] . ';font-family:' . $mega['content_family'] . ';font-size:' . $mega['content_size'] . ';}';
		...
		$css .= $compact . '{background:linear-gradient(90deg,' . $mobile['drawer_background_from'] . ',' . $mobile['drawer_background_to'] . ');}' . $compact . ' .nymegamenu__toggle{background:linear-gradient(90deg,' . $mobile['toggle_background_from'] . ',' . $mobile['toggle_background_to'] . ');border-radius:' . self::box( $mobile, 'toggle_radius' ) . ';color:' . $mobile['toggle_text'] . ';min-height:' . $mobile['toggle_height'] . ';}' . $compact . ' .nymegamenu__drawer{background:linear-gradient(90deg,' . $mobile['drawer_background_from'] . ',' . $mobile['drawer_background_to'] . ');padding:' . self::box( $mobile, 'drawer_padding' ) . ';}' . $compact . ' .nymegamenu__list>.nymegamenu__item>.nymegamenu__link,' . $compact . ' .nymegamenu__list>.nymegamenu__item>.nymegamenu__trigger{color:' . $mobile['item_color'] . ';font-size:' . $mobile['item_size'] . ';text-align:' . $mobile['item_align'] . ';}' . $compact . ' .nymegamenu__grid{grid-template-columns:repeat(' . absint( $mobile['mega_columns'] ) . ',minmax(0,1fr));}' . $compact . ' .nymegamenu__item.is-open>.nymegamenu__trigger{background:linear-gradient(90deg,' . $mobile['active_background_from'] . ',' . $mobile['active_background_to'] . ');color:' . $mobile['item_active_color'] . ';}';
