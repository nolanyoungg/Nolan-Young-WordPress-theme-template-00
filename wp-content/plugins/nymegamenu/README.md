...
2. Enable a registered location and choose its theme and interaction settings.
3. In **Appearance → Menus**, select a menu item and choose a flyout or a Mega Panel.
