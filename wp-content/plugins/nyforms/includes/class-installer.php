...
class Installer {
	public static function activate() {
		...
		dbDelta( "CREATE TABLE $entries (id bigint(20) unsigned NOT NULL AUTO_INCREMENT, form_id bigint(20) unsigned NOT NULL, form_revision bigint(20) unsigned NOT NULL, status varchar(20) NOT NULL DEFAULT 'active', is_read tinyint(1) NOT NULL DEFAULT 0, submitted_by bigint(20) unsigned NOT NULL DEFAULT 0, source_url text NOT NULL, request_hash char(64) NOT NULL DEFAULT '', submitted_at datetime NOT NULL, updated_at datetime NOT NULL, PRIMARY KEY  (id), KEY form_status (form_id,status), KEY submitted_at (submitted_at), KEY request_hash (request_hash)) $charset;" );
		...
		add_option( 'nyforms_db_version', NYFORMS_DB_VERSION );
