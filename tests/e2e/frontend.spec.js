...
test('front page renders the required accessible shell without browser errors', async ({ page }) => {
...
test('front page has no serious or critical automated accessibility violations', async ({ page }) => {
  await page.goto('/');
